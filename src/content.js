export const content = {
  et: {
    seo: {
      title: 'Willipu Karavanipark ja Külalistemaja · Peipsi järv',
      description:
        'Karavanipark 24/7 automaatse check-iniga Peipsi järve ääres — 41 kohta haagissuvilatele ja matkaautodele. Toad, kämpingumajad, liivarand ja peosaal.',
      ogDescription:
        'Karavanipark 24/7 automaatse check-iniga Peipsi järve ääres. Toad, kämpingumajad, liivarand ja peosaal 30-le.',
    },
    nav: {
      about: 'Meist',
      amenities: 'Tegevused',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Teenindushoone' },
            { url: '/teenindus2.jpg', alt: 'Teenindushoone' },
            { url: '/teenindus3.jpg', alt: 'Teenindushoone' },
            { url: '/teenindus4.jpg', alt: 'Teenindushoone' },
            { url: '/teenindus5.jpg', alt: 'Teenindushoone' },
            { url: '/teenindus6.jpg', alt: 'Teenindushoone' },
          ],
  ...
  en: {
    seo: {
      ...
      description:
        '24/7 caravan park with automated check-in on Lake Peipus — 41 pitches for caravans, motorhomes and campervans. Rooms, cottages, sandy beach, banquet hall.',
      ogDescription:
        '24/7 caravan park with automated check-in on Lake Peipus, Estonia — 41 pitches, plus rooms, cottages and a sandy beach.',
    },
    nav: {
      about: 'About',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Service building' },
            { url: '/teenindus2.jpg', alt: 'Service building' },
            { url: '/teenindus3.jpg', alt: 'Service building' },
            { url: '/teenindus4.jpg', alt: 'Service building' },
            { url: '/teenindus5.jpg', alt: 'Service building' },
            { url: '/teenindus6.jpg', alt: 'Service building' },
          ],
          photoCredit: 'pictures by Liisi Laanemäe',
          amenities: [
            { icon: 'kitchen', label: 'Kitchen' },
  ...
  de: {
    seo: {
      ...
      description:
        'Wohnmobil- und Wohnwagenstellplatz mit 24/7-Check-in am Peipussee — 41 Stellplätze mit Strom, Wasser und WLAN. Zimmer, Hütten, Sandstrand, Festsaal.',
      ogDescription:
        'Stellplatz mit 24/7-Check-in direkt am Peipussee in Estland — 41 Plätze, dazu Zimmer, Hütten und Sandstrand.',
    },
    nav: {
      about: 'Über uns',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Servicegebäude' },
            { url: '/teenindus2.jpg', alt: 'Servicegebäude' },
            { url: '/teenindus3.jpg', alt: 'Servicegebäude' },
            { url: '/teenindus4.jpg', alt: 'Servicegebäude' },
            { url: '/teenindus5.jpg', alt: 'Servicegebäude' },
            { url: '/teenindus6.jpg', alt: 'Servicegebäude' },
          ],
          photoCredit: 'pictures by Liisi Laanemäe',
          amenities: [
            { icon: 'kitchen', label: 'Küche' },
    ...
    seo: {
      ...
      description:
        'Asuntovaunu- ja matkailuautoalue 24/7-sisäänkirjautumisella Peipsijärven rannalla — 41 paikkaa: sähkö, vesi ja WiFi. Huoneita, mökkejä, hiekkaranta.',
      ogDescription:
        'Asuntovaunualue 24/7-sisäänkirjautumisella Peipsijärven rannalla Virossa — 41 paikkaa, huoneita, mökkejä ja hiekkaranta.',
    },
    nav: {
      about: 'Meistä',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Huoltorakennus' },
            { url: '/teenindus2.jpg', alt: 'Huoltorakennus' },
            { url: '/teenindus3.jpg', alt: 'Huoltorakennus' },
            { url: '/teenindus4.jpg', alt: 'Huoltorakennus' },
            { url: '/teenindus5.jpg', alt: 'Huoltorakennus' },
            { url: '/teenindus6.jpg', alt: 'Huoltorakennus' },
          ],
          photoCredit: 'pictures by Liisi Laanemäe',
          amenities: [
            { icon: 'kitchen', label: 'Keittiö' },
  ...
  lv: {
    seo: {
      ...
      description:
        'Kemperu un treileru kempings ar 24/7 reģistrāciju Peipusa ezera krastā — 41 vieta ar elektrību, ūdeni un WiFi. Istabas, namiņi, smilšu pludmale.',
      ogDescription:
        'Kempings ar 24/7 reģistrāciju Peipusa ezera krastā Igaunijā — 41 vieta, istabas, namiņi un smilšu pludmale.',
    },
    nav: {
      about: 'Par mums',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Servisa ēka' },
            { url: '/teenindus2.jpg', alt: 'Servisa ēka' },
            { url: '/teenindus3.jpg', alt: 'Servisa ēka' },
            { url: '/teenindus4.jpg', alt: 'Servisa ēka' },
            { url: '/teenindus5.jpg', alt: 'Servisa ēka' },
            { url: '/teenindus6.jpg', alt: 'Servisa ēka' },
          ],
          photoCredit: 'pictures by Liisi Laanemäe',
          amenities: [
            { icon: 'kitchen', label: 'Virtuve' },
  ...
  lt: {
    seo: {
      ...
      description:
        'Kemperių ir karavanų aikštelė su 24/7 registracija prie Peipaus ežero — 41 vieta su elektra, vandeniu ir WiFi. Kambariai, nameliai, paplūdimys.',
      ogDescription:
        'Kempingas su 24/7 registracija prie Peipaus ežero Estijoje — 41 vieta, kambariai, nameliai ir smėlio paplūdimys.',
    },
    nav: {
      about: 'Apie mus',
      amenities: 'Veikla',
      ...
      groups: [
        ...
        },
        {
          ...
          photos: [
            ...
            { url: '/teenindus1.jpg', alt: 'Aptarnavimo pastatas' },
            { url: '/teenindus2.jpg', alt: 'Aptarnavimo pastatas' },
            { url: '/teenindus3.jpg', alt: 'Aptarnavimo pastatas' },
            { url: '/teenindus4.jpg', alt: 'Aptarnavimo pastatas' },
            { url: '/teenindus5.jpg', alt: 'Aptarnavimo pastatas' },
            { url: '/teenindus6.jpg', alt: 'Aptarnavimo pastatas' },
          ],
          photoCredit: 'pictures by Liisi Laanemäe',
          amenities: [
            { icon: 'kitchen', label: 'Virtuvė' },
  ...
  ru: {
    seo: {
      ...
      description:
        'Кемпинг для автодомов и караванов с регистрацией 24/7 на Чудском озере — 41 место: электричество, вода, душ и WiFi. Номера, коттеджи, пляж.',
      ogDescription:
        'Кемпинг для автодомов с регистрацией 24/7 на берегу Чудского озера — 41 место, номера, коттеджи и песчаный пляж.',
    },
    nav: {
      about: 'О нас',
