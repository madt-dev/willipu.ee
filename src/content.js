export const content = {
  et: {
    ...
    pricing: {
      ...
      rows: [
        { item: 'Peamaja tuba', price: '25 € / inimene / öö' },
        { item: 'Pereaiamaja 3-le', price: '80 € / öö' },
        { item: 'Pereaiamaja 5-le', price: '110 € / öö' },
        { item: 'Väike aiamaja', price: '40 € / öö' },
        { item: 'Telkimine', price: '5 € / inimene' },
        { item: 'Haagissuvila ilma elektrita', price: '14 € / öö' },
        { item: 'Haagissuvila elektriga', price: '20 € / öö' },
  ...
  en: {
    ...
    pricing: {
      ...
      rows: [
        { item: 'Main house room', price: '€25 / person / night' },
        { item: 'Family cottage for 3', price: '€80 / night' },
        { item: 'Family cottage for 5', price: '€110 / night' },
        { item: 'Small cottage', price: '€40 / night' },
        { item: 'Tent camping', price: '€5 / person' },
        { item: 'Caravan without power', price: '€14 / night' },
        { item: 'Caravan with power', price: '€20 / night' },
